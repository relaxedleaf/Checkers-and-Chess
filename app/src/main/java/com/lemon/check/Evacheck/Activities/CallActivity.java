...
import com.lemon.check.Evacheck.Utils.InterfaceJava;
import com.lemon.check.Evacheck.Utils.Users;
import com.lemon.check.Evacheck.databinding.ActivityCallBinding;
...
public class CallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseRef = FirebaseDatabase.getInstance().getReference().child("Random");
