...
//**********************************
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.exists()) {
                                ...
                                if (coinsValue != null) {
                                    ...
                                    Log.e("CheckersRoomActivity", "Coins value is null");
                                }
                            } else {
                                Log.e("CheckersRoomActivity", "User snapshot does not exist");
                            }
                        }

                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Log.e("CheckersRoomActivity", "Database error: " + error.getMessage());
                        }
                    });
        }
        ...
        BtnReward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clickSound.start();
                Intent intent = new Intent(CheckerRoomActivity.this, RewardActivity.class);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (coins > 4) {
                    ...
                    Toast.makeText(CheckerRoomActivity.this, "Insufficient Coins Watch Reward Ads To Earn Coins!", Toast.LENGTH_SHORT).show();
                }
            }
